...
GSE42827_Non_normalized_counts <- GSE42827_Non_pvalue <- readRawData(geo, sequencePlatform)

gse <- GEOquery::getGEO(geo, GSEMatrix = FALSE)
colnames(GSE42827_Non_pvalue) <- colnames(GSE42827_Non_normalized_counts) <-
...
GSE42827_sobject <- SummarizedExperiment::SummarizedExperiment(
  assays = list(GSE42827_Non_normalized_counts = as.matrix(GSE42827_Non_normalized_counts)),
