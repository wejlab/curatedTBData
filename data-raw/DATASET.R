...
# Save clinical information table
Clinical_Information <- readxl::read_excel("data-raw/Data_summaryforpackage.xlsx",
                                                sheet = "Clinical_Information")
usethis::use_data(Clinical_Information, compress = "xz", overwrite = TRUE)
