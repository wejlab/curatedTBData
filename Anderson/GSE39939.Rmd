...
GSE39939_summarizedExperiemnt <- SummarizedExperiment(assays = list(GSEGSE39939_Non_normalized_counts= as.matrix(GSE39939_Non_normalized_counts)), colData = characteristic_data_frame, rowData = row_data, metadata = list(GSE39939_experimentData)); GSE39939_summarizedExperiemnt
