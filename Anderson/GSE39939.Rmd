...
```{r, cache = TRUE}
<<<<<<< HEAD
urls <- getGEOSuppFiles("GSE39939", fetch_files = FALSE);urls
...
filePaths <- getGEOSuppFiles("GSE39939")
GSE39939_Non_normalized <- read.delim("GSE39939/GSE39939_non-normalized_data.txt.gz", row.names = 1, header = TRUE)
>>>>>>> eddd8a8f44e55c2edc57d76b0030ee7d726335ec
...
GSE39939_final <- OUT_collapse %>% left_join(GSE39939_Non_pvalue, by=c("PROBEID" = 'ID_REF')) %>% as_tibble()
...
```{r}
saveRDS(GSE39939_summarizedExperiemnt, ascii=FALSE, file='~/Desktop/curatedTBData/Anderson/GSE39939/GSE39939_summarizedExperiemnt.RDS')
```
