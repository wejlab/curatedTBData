...
filePaths = getGEOSuppFiles("GSE39940")
GSE39940_Non_normalized <- read.delim("GSE39940/GSE39940_Sample_Probe_Profile_with_no_BG_subtracted_and_not_normalised_GEO_upload_CT_MLW_07_08_12.txt.gz", row.names = 1, header = TRUE)
...
GSE39940_final <- OUT_collapse %>% left_join(GSE39940_Non_pvalue, by=c("PROBEID" = 'ID_REF')) %>% as_tibble()
