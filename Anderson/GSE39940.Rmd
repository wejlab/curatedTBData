...
urls <- getGEOSuppFiles("GSE39940", fetch_files = FALSE);urls
...
```
```{r}
saveRDS(GSE39940_summarizedExperiemnt, ascii=FALSE, file='~/Desktop/curatedTBData/Anderson/GSE39940/GSE39940_summarizedExperiemnt.RDS')
