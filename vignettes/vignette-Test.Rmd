...
get_curatedTBData(geo_access = c("GSE39939","GSE107993"), include.reprocess = TRUE)
...
```{r load a list of RNA-seq studies, results='hide'}
# To get a summary table for all the studies:
# data("DataSummary",package="curatedTBData")
...
## Load a list of RNA-seq data
```{r load a list of microarray studies, results='hide'}
...
GSE107991_mobject_norm <- Normalization(GSE107991_mobject, RNAseq_method = "TMM", 
