...
# Take long time... Consider to reduce the runnning time
...
# Select Patients with HIV Positive
```{r}
# Select objects with HIV information
object_match_HIV <- lapply(object_match, function(x) subset_curatedTBData(x,))
multi_set_PTB_Latent_HIV <- bplapply(object_match, function(x)
...
# Select Patients with Diabetets Positive
