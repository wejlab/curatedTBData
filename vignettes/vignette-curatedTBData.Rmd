...
for (i in names(TBsignatures)){
  ...
  BoxplotTBSig(ssgsea_PTB_Latent1, sig_name = i, annotationName = "TBStatus")
...
for (i in names(TBsignatures)){
  ...
  BoxplotTBSig(MDP_result, sig_name = i, annotationName = "TBStatus")
...
```{r, results = "asis", message = FALSE, fig.height = 28, fig.width=30}
BoxplotTBSig(MDP_result_NULL, sig_name = NULL, annotationName = "TBStatus")
```
