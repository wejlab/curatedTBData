...
# Manually rename clinical information...
...
# Convert to standard column information 
col_data <- create_standard_ColData(GSE19442_raw$col_data)
...
GSE19442 <- SummarizedExperiment(assays = list(GSE19442_Non_normalized_counts= as.matrix(GSE19442_raw$counts)), colData = col_data, rowData = GSE19442_raw$row_data, metadata = list(GSE19442_experimentData)); GSE19442
```
