...
colnames(GSE36238_raw$col_data) <- c('TimePoint','Tissue','Pateient_id','SampleTime')
...
# Load a list of available SummarizedExperiment/MultiAssayExperiment Objects
...
# Define new function to show boxplot across signatures
