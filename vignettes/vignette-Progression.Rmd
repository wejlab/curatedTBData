...
# Get summarized table and bootstrap 95% Confidence Interval
cbind(Signature=sapply(progress_auc_summary_singscore, function(x) x$Signature[1]),
...
# Get summarized table and bootstrap 95% Confidence Interval
cbind(Signature=sapply(progress_auc_summary_plage, function(x) x$Signature[1]),
