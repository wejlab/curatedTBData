...
```{r, meassge = FALSE, results = 'hide', include=FALSE}
devtools::load_all()
```
...
object_list <- curatedTBData(myGEO, dryrun = FALSE, curated.only = TRUE)
object_list[1:2]
```
...
```{r}
GSE19491 <- combineObjects(object_list, experiment_name = "assay_curated")
GSE19491
...
exp <- combineObjects(c(GSE79362[1], object_list[1]),
