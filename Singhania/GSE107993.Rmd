...
GSE107993_summarizedExperiemnt <- SummarizedExperiment(assays = list(GSE107993_Non_normalized_counts= as.matrix(GSE107993_raw_counts)), colData = DataFrame(characteristic_data_frame), rowData = row_data, metadata = list(GSE107993_experimentData)); GSE107993_summarizedExperiemnt
...
TBStatus <- ifelse(TBStatus_temp=='LTBI','Latent',TBStatus_temp)
TBStatus
...
row_data$SYMBOL_NEW <- row_data$Gene_name
