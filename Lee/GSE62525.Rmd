...
GSE62525_RG <- read.maimages(gprFiles, source="genepix",columns = list(R = "F635 Median", Rb = "B635 Median"))
```
...
GSE62525_raw <- GSE62525_RG$E-GSE62525_RG$Eb
...
row.names(characteristic_data_frame) <- colnames(GSE62525_Non_normalized_counts)
```
