...
GSE6112_summarizedExperiemnt <- SummarizedExperiment(assays = list(GSE6112_Non_normalized_counts= as.matrix(GSE6112_raw_value)), colData = characteristic_data_frame, rowData = row_data, metadata = list(GSE6112_experimentData)); GSE6112_summarizedExperiemnt
