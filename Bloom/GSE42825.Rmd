...
# Annotation
PROBES <- row.names(GSE42825_Non_pvalue)
...
GSE42825_final <- GSE42825_Non_pvalue %>% left_join(OUT_collapse, by=c('ID_REF'="PROBEID")) %>% left_join(GPL10558_HumanHT_dat, by = c('ID_REF'='ID')) 

# Create Row data annotation
row_data <- GSE42825_final %>% dplyr::select(-grep('GSM',colnames(GSE42825_final))) %>% DataFrame()
