...
# Annotation
PROBES <- row.names(GSE42826_Non_pvalue) 
...
GSE42826_final <- GSE42826_Non_pvalue %>% left_join(OUT_collapse, by=c('ID_REF'="PROBEID")) %>% left_join(GPL10558_HumanHT_dat, by = c('ID_REF'='ID')) 

# Create Row data annotation
row_data <- GSE42826_final %>% dplyr::select(-grep('GSM',colnames(GSE42826_final))) %>% DataFrame()
```
